...
print(analisysUnresolvedProjectsByCategoryByProvince)
...
app = Dash(__name__,title='Proyecto de Investigacion De Operaciones')
...
app.layout = html.Main([
    ...
    html.Header(children=[
        html.Div(children=[
            html.Span(
            children=[
                html.H1(children='Proyecto de investigacion de operaciones',
                className="banner--modern__title"),
                html.P(children='Desarrollador por: Israel David Villarroel Moreno',className="banner--modern__description"),
                html.P(children='Bajo la supervision de: Karla Lopez',className="banner--modern__description"
            ),
        ],className='banner--modern__text'),

        html.Span(children=[
            html.Img(src='/assets/LOGO_UNEG.jpg',className="")
        ],className='banner--modern__figure'), 
